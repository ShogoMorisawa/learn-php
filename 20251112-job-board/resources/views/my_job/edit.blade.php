        ...
        <form action="{{ route('my-jobs.update', $job) }}" method="POST">
            ...
            <div class="mb-4 grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <x-radio-group name="experience" :value="old('experience', $job->experience)" :requere-option-all="false"
                ...
                <div>
                    ...
                    <x-radio-group name="category" :value="old('category', $job->category)" :requere-option-all="false"
